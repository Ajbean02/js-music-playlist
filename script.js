...
let songs = [
    ...
    { title: "Levitating", artist: "Dua Lipa", duration: "3:23", liked: false},
    { title: "Don't Start Now", artist: "Dua Lipa", duration: "3:03", liked: true},
    { title: "Watermelon Sugar", artist: "Harry Styles", duration: "2:54", liked:false},
    { title: "Circles", artist: "Post Malone", duration: "3:35", liked: true},
    { title: "Adore You", artist: "Harry Styles", duration: "3:27", liked: false},
    { title: "Savage Love", artist: "Jason Derulo", duration: "2:51", liked: true},
    { title: "Rockstar", artist: "Dababy feat. Roddy Ricch", duration "3:01", liked: false}
];
...
for (let i = 0; i < songs.length; i++) {
    ...
    let songDiv = document.createElement("div");
        ...
        duration.innerText = "Duration:" + song.duration;
        songDiv.appendChild(favorite);

        if (song.liked) { 
            let favorite = document.createElementNS("p");
            songDiv.appendChild(favorite);
        }
}
